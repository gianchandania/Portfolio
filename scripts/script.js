...
function scrollingEvents() {
	...
	aboutMe.addEventListener("mouseover", function() {
		...
		header1.style.background = "linear-gradient(rgba(39, 174, 96,0.8), rgba(39, 174, 96,0.8)), url('images/final.jpg') no-repeat fixed center center";
	...
	myWork.addEventListener("mouseover", function() {
		...
		header1.style.background = "linear-gradient(rgba(248, 54, 0,0.63), rgba(248, 54, 0,0.63)), url('images/mywork.jpg') no-repeat fixed center center";
	...
	myInterest.addEventListener("mouseover", function() {
		...
		header1.style.background = "linear-gradient(rgba(186, 139, 2,0.7), rgba(186, 139, 2,0.7)), url('images/headhobby1.jpg') no-repeat fixed center center";
	...
	var myContact = document.getElementById("chat");

	myContact.addEventListener("mouseover", function() {

		header1.style.background = "linear-gradient(rgba(231, 76, 60,0.7), rgba(231, 76, 60,0.7)), url('images/contactme.jpg') no-repeat fixed center center";
	
		header1.style.backgroundSize = "100% 100%";

});

	myContact.addEventListener("mouseout", function() {
